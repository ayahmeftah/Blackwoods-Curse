...
{
    [TaskDescription("Find a place to hide and move to it using the Unity NavMesh. The task can optionally look at the cover point after the agent has arrived.")]
